...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo get_stylesheet_directory_uri(); ?>/twentyeleven.css?ver=<?php echo filemtime(dirname(__FILE__).'/twentyeleven.css'); ?>" />
